...
export default function Home() {
  ...
  async function importArticle(e:FormEvent) {
    ...
    try {
      const article=await api<Article>('articles','POST',{url:importMode==='url'?importUrl:'',text:importMode==='text'?importText:undefined,title:importTitle,process:configured&&importProcess,voice:importVoice});
...
function ArticleModal({initial,voices,configured,onClose,onChange,onPlay,onSettings,onReprocess}:{voices:CustomVoice[];onReprocess:()=>void;initial:Article;configured:boolean;onClose:()=>void;onChange:()=>void;onPlay:(a:Article)=>void;onSettings:()=>void}) {
